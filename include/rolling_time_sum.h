...
namespace boost 
{
    namespace accumulators
    {
        namespace impl
        {
            ...
            struct rolling_time_sum_impl
                : accumulator_base
            {
                typedef Sample result_type;

                template<typename Args>
                rolling_time_sum_impl(Args const &args)
        ...
        namespace tag
        {
            struct rolling_time_sum
                : depends_on< rolling_time_window >
            {
                /// INTERNAL ONLY
                ///
                typedef accumulators::impl::rolling_time_sum_impl< mpl::_1 > impl;
        ...
        namespace extract
        {
            extractor<tag::rolling_time_sum> const rolling_time_sum = {};

            BOOST_ACCUMULATORS_IGNORE_GLOBAL(rolling_time_sum)
        }

        using extract::rolling_time_sum;
    }
